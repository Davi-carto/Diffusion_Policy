    ...
    def run(self):
        ...
        try:
            ...
            while keep_running:
                ...
                # send command to robot，即执行当前时刻因该到达的pose
                ...
                for i in range(n_cmd):
                    ...
                    if cmd == Command.STOP.value:
                        ...
                        #实际执行是在下一次while中执行的 所以curr_time=本次while开始的时间 + dt
                        curr_time = t_now + dt
                ...
                A combination of sleeping and spinning are used to achieve the lowest possible jitter. 
                The function is especially useful for a realtime control loop.  
                '''
